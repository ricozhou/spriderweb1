app.controller('homeCtrl', [ '$scope', '$resource', '$location',
		function($scope, $resource, $location) {
			...
			$scope.showPosts = function() {
				var postResource = $resource('post/show', {}, {
					query : {
						method : 'GET',
						isArray : false
					}
			...
			$scope.addPost = function() {
				var postResource = $resource('post/new', {}, {
					save : {
						method : 'POST'
					}
				});
			...
			$scope.addComment = function() {
				...
				var commentResource = $resource('comment/new', {}, {
					save : {
						method : 'POST'
					}
				});
			...
			$scope.likeOrNot = function(id, flag) {
				console.log(id, '...', flag);
				var postResource = $resource('post/likes/:id/:flag', {
					id : id,
					flag : flag
				}, {
					save : {
